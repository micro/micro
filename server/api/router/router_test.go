...
import (
	...
	"github.com/micro/micro/v3/server/api/handler/rpc"
	"github.com/micro/micro/v3/server/api/router"
	rregistry "github.com/micro/micro/v3/server/api/router/registry"
	rstatic "github.com/micro/micro/v3/server/api/router/static"
