...
impl AuthClient {
    pub fn generate(&self, o: ::grpc::RequestOptions, req: super::auth::GenerateRequest) -> ::grpc::SingleResponse<super::auth::GenerateResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Auth/Generate"),
    ...
    pub fn inspect(&self, o: ::grpc::RequestOptions, req: super::auth::InspectRequest) -> ::grpc::SingleResponse<super::auth::InspectResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Auth/Inspect"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn token(&self, o: ::grpc::RequestOptions, req: super::auth::TokenRequest) -> ::grpc::SingleResponse<super::auth::TokenResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Auth/Token"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
...
impl AuthServer {
    pub fn new_service_def<H : Auth + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        ...
        ::grpc::rt::ServerServiceDefinition::new("/auth.Auth",
            vec![
...
pub trait Accounts {
    ...
    fn delete(&self, o: ::grpc::ServerHandlerContext, req: ::grpc::ServerRequestSingle<super::auth::DeleteAccountRequest>, resp: ::grpc::ServerResponseUnarySink<super::auth::DeleteAccountResponse>) -> ::grpc::Result<()>;

    fn change_secret(&self, o: ::grpc::ServerHandlerContext, req: ::grpc::ServerRequestSingle<super::auth::ChangeSecretRequest>, resp: ::grpc::ServerResponseUnarySink<super::auth::ChangeSecretResponse>) -> ::grpc::Result<()>;
}
...
impl AccountsClient {
    pub fn list(&self, o: ::grpc::RequestOptions, req: super::auth::ListAccountsRequest) -> ::grpc::SingleResponse<super::auth::ListAccountsResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Accounts/List"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn delete(&self, o: ::grpc::RequestOptions, req: super::auth::DeleteAccountRequest) -> ::grpc::SingleResponse<super::auth::DeleteAccountResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Accounts/Delete"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn change_secret(&self, o: ::grpc::RequestOptions, req: super::auth::ChangeSecretRequest) -> ::grpc::SingleResponse<super::auth::ChangeSecretResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Accounts/ChangeSecret"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
...
impl AccountsServer {
    pub fn new_service_def<H : Accounts + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        let handler_arc = ::std::sync::Arc::new(handler);
        ::grpc::rt::ServerServiceDefinition::new("/auth.Accounts",
            vec![
                ::grpc::rt::ServerMethod::new(
                    ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
                        name: ::grpc::rt::StringOrStatic::Static("/auth.Accounts/List"),
                ...
                ::grpc::rt::ServerMethod::new(
                    ...
                    {
                        let handler_copy = handler_arc.clone();
                        ::grpc::rt::MethodHandlerUnary::new(move |ctx, req, resp| (*handler_copy).change_secret(ctx, req, resp))
                    },
                ),
            ],
        )
...
impl RulesClient {
    pub fn create(&self, o: ::grpc::RequestOptions, req: super::auth::CreateRequest) -> ::grpc::SingleResponse<super::auth::CreateResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Rules/Create"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn delete(&self, o: ::grpc::RequestOptions, req: super::auth::DeleteRequest) -> ::grpc::SingleResponse<super::auth::DeleteResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Rules/Delete"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn list(&self, o: ::grpc::RequestOptions, req: super::auth::ListRequest) -> ::grpc::SingleResponse<super::auth::ListResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/auth.Rules/List"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
...
impl RulesServer {
    pub fn new_service_def<H : Rules + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        let handler_arc = ::std::sync::Arc::new(handler);
        ::grpc::rt::ServerServiceDefinition::new("/auth.Rules",
            vec![
                ::grpc::rt::ServerMethod::new(
                    ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
                        name: ::grpc::rt::StringOrStatic::Static("/auth.Rules/Create"),
