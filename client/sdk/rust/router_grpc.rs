...
impl RouterClient {
    pub fn lookup(&self, o: ::grpc::RequestOptions, req: super::router::LookupRequest) -> ::grpc::SingleResponse<super::router::LookupResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/router.Router/Lookup"),
    ...
    pub fn watch(&self, o: ::grpc::RequestOptions, req: super::router::WatchRequest) -> ::grpc::StreamingResponse<super::router::Event> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/router.Router/Watch"),
...
impl RouterServer {
    pub fn new_service_def<H : Router + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        ...
        ::grpc::rt::ServerServiceDefinition::new("/router.Router",
            vec![
...
pub trait Table {
    ...
    fn read(&self, o: ::grpc::ServerHandlerContext, req: ::grpc::ServerRequestSingle<super::router::ReadRequest>, resp: ::grpc::ServerResponseUnarySink<super::router::ReadResponse>) -> ::grpc::Result<()>;
}
...
impl TableClient {
    pub fn create(&self, o: ::grpc::RequestOptions, req: super::router::Route) -> ::grpc::SingleResponse<super::router::CreateResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/router.Table/Create"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn delete(&self, o: ::grpc::RequestOptions, req: super::router::Route) -> ::grpc::SingleResponse<super::router::DeleteResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/router.Table/Delete"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn update(&self, o: ::grpc::RequestOptions, req: super::router::Route) -> ::grpc::SingleResponse<super::router::UpdateResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/router.Table/Update"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
    ...
    pub fn read(&self, o: ::grpc::RequestOptions, req: super::router::ReadRequest) -> ::grpc::SingleResponse<super::router::ReadResponse> {
        let descriptor = ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
            name: ::grpc::rt::StringOrStatic::Static("/router.Table/Read"),
            streaming: ::grpc::rt::GrpcStreaming::Unary,
            req_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
            resp_marshaller: ::grpc::rt::ArcOrStatic::Static(&::grpc_protobuf::MarshallerProtobuf),
        });
...
impl TableServer {
    pub fn new_service_def<H : Table + 'static + Sync + Send + 'static>(handler: H) -> ::grpc::rt::ServerServiceDefinition {
        let handler_arc = ::std::sync::Arc::new(handler);
        ::grpc::rt::ServerServiceDefinition::new("/router.Table",
            vec![
                ::grpc::rt::ServerMethod::new(
                    ::grpc::rt::ArcOrStatic::Static(&::grpc::rt::MethodDescriptor {
                        name: ::grpc::rt::StringOrStatic::Static("/router.Table/Create"),
