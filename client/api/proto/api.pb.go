...
// source: github.com/micro/micro/v2/api/proto/api.proto
...
func init() {
	proto.RegisterFile("github.com/micro/micro/v2/api/proto/api.proto", fileDescriptor_api_f8ef31c2e6dafc0b)
}
