...
var _Say_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/micro/micro/examples/secure/srv/proto/hello/hello.proto",
}

func init() {
	proto.RegisterFile("github.com/micro/micro/examples/secure/srv/proto/hello/hello.proto", fileDescriptor0)
}
