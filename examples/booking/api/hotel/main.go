...
import (
	...
	"github.com/micro/micro/examples/booking/api/hotel/proto"
	"github.com/micro/micro/examples/booking/srv/auth/proto"
	"github.com/micro/micro/examples/booking/srv/geo/proto"
	"github.com/micro/micro/examples/booking/srv/profile/proto"
	"github.com/micro/micro/examples/booking/srv/rate/proto"
)
...
func getRatePlans(c client.Client, ctx context.Context, hotelIDs []string, inDate string, outDate string) chan rateResults {
	rateClient := rate.NewRateClient("go.micro.srv.rate", c)
...
func getHotelProfiles(c client.Client, ctx context.Context, hotelIDs []string) chan profileResults {
	profileClient := profile.NewProfileClient("go.micro.srv.profile", c)
