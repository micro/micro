...
// source: asim/micro/micro/examples/greeter/srv/proto/hello/hello.proto
...
func init() {
	proto.RegisterFile("asim/micro/micro/examples/greeter/srv/proto/hello/hello.proto", fileDescriptor_f9c4d46e1c0507ba)
}
