...
const Signup = `{
  ...
  "paths": {
    "/test/Signup/CompleteSignup": {
      ...
      "summary": "signup.proto: Signup.CompleteSignup()"
    },
    "/test/Signup/HasPaymentMethod": {
      ...
      "summary": "signup.proto: Signup.HasPaymentMethod()"
    },
    "/test/Signup/Recover": {
      "parameters": [
        {
      ...
      "summary": "signup.proto: Signup.Recover()"
    },
    "/test/Signup/SendVerificationEmail": {
      ...
      "summary": "signup.proto: Signup.SendVerificationEmail()"
    },
    "/test/Signup/SetPaymentMethod": {
      ...
      "summary": "signup.proto: Signup.SetPaymentMethod()"
    },
    "/test/Signup/Verify": {
      "parameters": [
        {
      ...
      "summary": "signup.proto: Signup.Verify()"
    }
  },
  "servers": [
    {
