...
var (
	...
	statements = map[string]string{
		"list":       "SELECT key, value, metadata, expiry FROM %s.%s WHERE key LIKE $1 LIMIT $2 OFFSET $3;",
		...
		"readOffset": "SELECT key, value, metadata, expiry FROM %s.%s WHERE key LIKE $1 LIMIT $2 OFFSET $3;",
