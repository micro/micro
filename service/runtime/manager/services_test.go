...
func TestServices(t *testing.T) {
	testServices := []*runtime.Service{
		&runtime.Service{Name: "service.foo", Version: "2.0.0"},
		&runtime.Service{Name: "service.foo", Version: "1.0.0"},
		&runtime.Service{Name: "service.bar", Version: "latest"},
	}
	...
	t.Run("ReadServicesWithName", func(t *testing.T) {
		srvs, err := m.readServices(testNamespace, &runtime.Service{Name: "service.foo"})
		if err != nil {
			t.Fatalf("Unexpected error when reading services%v", err)
		}
		if len(srvs) != 2 {
	...
	t.Run("ReadServicesWithNameAndVersion", func(t *testing.T) {
		query := &runtime.Service{Name: "service.foo", Version: "1.0.0"}
	...
	t.Run("NamespaceScope", func(t *testing.T) {
		srv := &runtime.Service{Name: "service.apple", Version: "latest"}
