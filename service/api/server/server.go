...
import (
	...
	ahandler "github.com/micro/micro/v3/service/api/server/handler"
	aapi "github.com/micro/micro/v3/service/api/server/handler/api"
	"github.com/micro/micro/v3/service/api/server/handler/event"
	ahttp "github.com/micro/micro/v3/service/api/server/handler/http"
	arpc "github.com/micro/micro/v3/service/api/server/handler/rpc"
	"github.com/micro/micro/v3/service/api/server/handler/web"
	"github.com/micro/micro/v3/service/api/server/resolver"
	"github.com/micro/micro/v3/service/api/server/resolver/grpc"
	"github.com/micro/micro/v3/service/api/server/resolver/host"
	"github.com/micro/micro/v3/service/api/server/resolver/path"
	"github.com/micro/micro/v3/service/api/server/resolver/subdomain"
	"github.com/micro/micro/v3/service/api/server/router"
	regRouter "github.com/micro/micro/v3/service/api/server/router/registry"
	apiserver "github.com/micro/micro/v3/service/api/server/server"
	httpapi "github.com/micro/micro/v3/service/api/server/server/http"
