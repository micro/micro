...
## What's the different between Micro and Go Micro?
...
a platform for cloud native development which includes a server, command line and service library (previous go-micro). Go Micro is now 
