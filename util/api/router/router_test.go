...
import (
	...
	"github.com/micro/micro/v3/util/api/handler"
	"github.com/micro/micro/v3/util/api/handler/rpc"
	"github.com/micro/micro/v3/util/api/router"
	rregistry "github.com/micro/micro/v3/util/api/router/registry"
	rstatic "github.com/micro/micro/v3/util/api/router/static"
